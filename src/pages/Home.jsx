...
import bgImage from "../assets/layered-waves-haikei.svg"
...
function Home() {
  return (
    <div className="bg-[url('../assets/layered-waves-haikei.svg')] bg-fixed bg-cover bg-center bg-no-repeat">
      ...
      {/* Footer */}
      <footer className="fixed bottom-0 right-0 pb-4 pr-4">
        <div className="flex justify-end items-center px-6 py-3">
          <aside className="flex items-center gap-2 bg-gunmetal-400/20 backdrop-blur-sm px-6 py-2 rounded-full">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
